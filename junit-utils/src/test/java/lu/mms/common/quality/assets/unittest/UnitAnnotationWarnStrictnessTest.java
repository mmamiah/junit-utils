...
class UnitAnnotationWarnStrictnessTest {
    ...
    @Test
    void shouldIncludeMockitoSettingsWithSpecificValueStrictnessWhenStrictnessWithNonDefaultValue() {
        // Arrange
        // Should be the same as the one passed in test class annotation.
        final Strictness warnStrictness = Strictness.WARN;
        ...
        assertThat(unitTestAnnotation.strictness(), equalTo(warnStrictness));
        ...
        assertThat(mockitoSettingsAnnotation.strictness(), equalTo(warnStrictness));
