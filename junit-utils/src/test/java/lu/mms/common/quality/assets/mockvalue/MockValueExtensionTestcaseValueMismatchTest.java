...
/**
 * Test to ensure that nothing happen in case of @{@link MockValue#testcase()} mismatch.
 */
@ExtendWith(MockitoExtension.class)
class MockValueExtensionTestcaseValueMismatchTest {
    ...
    @MockValue(value = "${po_name_mismatch}", testcase = "anotherTest")
    ...
    @Test
    void shouldNotSetTheSutPropertyWhenTestcaseMismatch() {
        // Arrange
