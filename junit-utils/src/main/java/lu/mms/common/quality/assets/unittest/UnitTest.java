...
/**
 * UnitTest annotation, extended with framework relevant functionalities. <br>
 ...
 *     </li>
 *
 *     <li>{@link UnitTestExtension}: Framework helper.</li>
 *     <li>{@link BeanLifeCycleExtension}: Test the bean lifecycle methods.</li>
...
public @interface UnitTest {
    /**
     * The default unit test {@link Tag}.
     */
    String UNIT_TEST_KEY = "unit_test";

    /**
     * The {@link MockitoSettings} strictness.
     * @return The Strictness object.
     */
     ...
     */
    String[] tags() default UNIT_TEST_KEY;
    ...
    /**
     * Enable test instance <b>non-mock</b> members lifecycle methods execution when relevant.
     * @see BeanLifeCycleExtension
     * @return <b>true</b>,  enable bean lifecycle execution <br>
     *         <b>false</b>, disable bean lifecycle execution
     */
    boolean lifeCycle() default true;
