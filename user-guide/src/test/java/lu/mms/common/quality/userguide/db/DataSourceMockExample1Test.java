package lu.mms.common.quality.userguide.db;

import lu.mms.common.quality.assets.db.DataSourceMock;
...
class DataSourceMockExample1Test {
    ...
    void shouldBuildH2DataSourceMockWhenCallingH2Builder() throws SQLException {
        // Act
        final DataSource dataSource = DataSourceMock.newH2Mock().build();
