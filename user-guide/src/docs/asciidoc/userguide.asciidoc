...
extension _MyBatisExtension_, which registered by default by _@MyBatisMapperTest_).
...
test method|`true`
m|mapperClass|An array of Mapper classes to be added to MyBatis configuration.|
|===
